  ...
  return (
        ...
        <form className='flex flex-col sm:flex-row gap-12'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                rounded-lg' id='name' maxLength='62' minLength='8' required></input>

                <input type='text' placeholder='Description' className='border p-3
                rounded-lg' id='description' maxLength='62' minLength='10' required></input>

                <input type='text' placeholder='Address' className='border p-3
                rounded-lg' id='address' maxLength='62' minLength='10' required></input>
                ...
                <div className='flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                        ...
                        className='p-3 border border-gray-300 rounded-lg'></input>
                        <p>Beds</p>
                    </div>
                    <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    type='file' id='images' accept='images/*' multiple></input>
            ...
            hover:opacity-70 disabled:opacity-50'>Create Listing</button>
        </div>
        </form>
     </main>
  )
